                    ...
                    <table id="example2" class="table table-bordered table-striped" style="font-size: 13px !important">
                        ...
                        @foreach($merged as $student)
                            <tr>
                                ...
                                <td style="text-align: center"><b>{{isset($student->serialNumber) ? $student->serialNumber : 'Нет данных'}}</b></td>
                                <td>
                                    <button class="btn btn-block btn-success" data-toggle="modal" data-target="#modal-lg"
                                            onclick="fillModal('{{ $student->StudentID }}', '{{ $student->FioStudent }}')">
                                        Выдать
                                    </button>
                                    <br>
